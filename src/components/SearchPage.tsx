          ...
          >
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full bg-forest-muted hover:bg-forest-hover focus:bg-forest-hover border border-forest-border focus:border-mint/50 rounded-[14px] sm:rounded-full pl-11 pr-4 py-3 text-white text-sm outline-none transition-all placeholder:text-sprout/50 font-sans"
                id="filter-name"
              />
            </div>
            ...
            <button
              ...
              className="relative shrink-0 bg-forest-muted hover:bg-forest-hover border border-forest-border hover:border-mint/40 rounded-[14px] sm:rounded-full px-5 py-3 text-sm text-white flex items-center justify-center gap-2 cursor-pointer transition-all outline-none"
              id="open-filters-btn"
            >
