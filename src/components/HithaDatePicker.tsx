...
export default function HithaDatePicker({ selectedDate, onDateChange, onClose }: HithaDatePickerProps) {
  ...
  return (
    <div
      className="absolute top-full right-0 mt-2 bg-[#0C1E18] border border-[#234438] rounded-[24px] shadow-2xl p-3 sm:p-5 z-50 animate-fade-in flex flex-col w-[calc(100vw-32px)] sm:w-[650px] max-w-[650px]"
    ...
    >
      ...
      <div className="flex justify-between items-center pb-3 border-b border-[#234438] mb-4">
        ...
        <button
          type="button"
          onClick={onClose}
          className="p-1 rounded-full hover:bg-[#152B22] text-sprout/60 hover:text-white transition-all cursor-pointer focus:outline-none"
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5 h-[340px] md:h-[280px]">
        {/* Column 1: Calendar Day Grid (7 cols out of 12) */}
        <div className="md:col-span-7 flex flex-col justify-between border-b md:border-b-0 md:border-r border-[#234438] pb-4 md:pb-0 md:pr-4">
            ...
            {daysArray.map((day, idx) => {
              ...
              return (
                <button
                  ...
                  className={`w-full aspect-square rounded-[8px] text-xs font-sans font-medium flex items-center justify-center transition-all cursor-pointer ${
                    isSelected
        ...
        <div className="hidden sm:flex md:col-span-3 flex-col border-r border-[#234438] pr-3">
        ...
        <div className="hidden sm:flex md:col-span-2 flex-col">
          <span className="text-[10px] font-sans font-bold text-sprout/40 uppercase tracking-wider mb-2 block">
            Select Year
          </span>
          <div
