...
export default function AdminNavbar({ isRealDocsLoading = false, onLogout }: AdminNavbarProps) {
  ...
  return (
    <nav
      className={`sticky top-0 z-40 shadow-resting ${isLogin ? 'bg-white border-b border-hairline text-forest' : 'bg-forest-dark border-b border-forest-hover text-white'}`}
      id="admin-navbar"
    >
          ...
          {!isLogin && (
            <div className="flex items-center space-x-4">
              <button 
                ...
                className="p-2 hover:bg-forest-muted rounded-full transition-all text-sprout/80 hover:text-white cursor-pointer focus:outline-none"
              ...
              <div className="flex items-center space-x-2.5 pl-2 border-l border-forest-hover" id="admin-nav-profile">
