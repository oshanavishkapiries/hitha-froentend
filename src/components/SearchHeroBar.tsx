      ...
      >
        ...
        <div className="relative lg:flex-1 w-full">
          ...
          <input
            ...
            className="w-full bg-forest-muted hover:bg-forest-hover focus:bg-forest-hover border border-forest-border focus:border-mint/50 rounded-[14px] lg:rounded-full pl-11 pr-4 py-3 lg:py-3.5 text-white text-sm outline-none transition-all placeholder:text-sprout/50 font-sans"
        ...
        <div className="relative lg:flex-1 w-full">
          <button
            ...
            className="w-full bg-forest-muted hover:bg-forest-hover border border-forest-border hover:border-mint/40 rounded-[14px] lg:rounded-full px-5 py-3 lg:py-3.5 text-left text-sm text-white flex items-center justify-between cursor-pointer transition-all outline-none"
          ...
          {isDropdownOpen && (
            <>
              ...
              />
              <div 
                className="absolute top-full left-0 right-0 mt-2 bg-ink border border-forest-border rounded-[16px] shadow-2xl p-3 z-50 animate-fade-in flex flex-col gap-2"
              ...
              >
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-forest-muted border border-forest-border text-white text-xs rounded-[10px] px-3 py-2 outline-none focus:border-mint/50 placeholder:text-sprout/40"
                      ...
                      <button
                        ...
                        className={`w-full text-left px-3 py-2.5 rounded-[10px] text-xs transition-colors flex items-center justify-between cursor-pointer ${
                          category === spec
                            ...
                            : 'text-white hover:bg-forest-hover'
                        }`}
                      >
                        <span>{spec}</span>
                      </button>
